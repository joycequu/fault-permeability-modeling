...
for combo = 1 : 4
    ...
    % do it 5 times first
    for l = 1 : 20 % l = EEk (number of repeats)
        ...
        zf_val = 200 + (1000 - 200)*rand;
        zmax_val = 1000 + (3000 - 1000)*rand;
        ...
        for d = 1 : 7
            ...
            % Instantiate fault section and get segmentation for this realization
                ...
                faultPerm = faultPerm + myFault.Perm;
...
save('fault_perm_3_layer.mat', 'all_ee');
