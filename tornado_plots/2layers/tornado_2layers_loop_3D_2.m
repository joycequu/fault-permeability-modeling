...
input_data = zeros(13, 6);

% FW: Sand, Clay; HW: Clay
% input_data(1, :) = [0.2, 0.65, 0.65, 65, 600, 2000]; % "baseline" 
% input_data(2, :) = [0.1, 0.65, 0.65, 65, 600, 2000]; % "vcl_fw_1_lower" % sand
% input_data(3, :) = [0.3, 0.65, 0.65, 65, 600, 2000]; % "vcl_fw_1_upper"
% input_data(4, :) = [0.2, 0.4, 0.65, 65, 600, 2000]; % "vcl_fw_2_lower" % clay
% input_data(5, :) = [0.2, 0.9, 0.65, 65, 600, 2000]; % "vcl_fw_2_upper"
% input_data(6, :) = [0.2, 0.65, 0.4, 65, 600, 2000]; % "vcl_hw_lower" % clay
% input_data(7, :) = [0.2, 0.65, 0.9, 65, 600, 2000]; % "vcl_hw_upper"
% input_data(8, :) = [0.2, 0.65, 0.65, 50, 600, 2000]; % "fdip_lower"
% input_data(9, :) = [0.2, 0.65, 0.65, 80, 600, 2000]; % "fdip_upper"
% input_data(10, :) = [0.2, 0.65, 0.65, 65, 200, 2000]; % "zf_lower"
% input_data(11, :) = [0.2, 0.65, 0.65, 65, 1000, 2000]; % "zf_upper"
% input_data(12, :) = [0.2, 0.65, 0.65, 65, 600, 1000]; % "zmax_lower"
% input_data(13, :) = [0.2, 0.65, 0.65, 65, 600, 3000]; % "zmax_upper"

% FW: Sand, Clay; HW: Sand
% input_data(1, :) = [0.2, 0.65, 0.2, 65, 600, 2000]; % "baseline" 
% input_data(2, :) = [0.1, 0.65, 0.2, 65, 600, 2000]; % "vcl_fw_1_lower" % sand
% input_data(3, :) = [0.3, 0.65, 0.2, 65, 600, 2000]; % "vcl_fw_1_upper"
% input_data(4, :) = [0.2, 0.4, 0.2, 65, 600, 2000]; % "vcl_fw_2_lower" % clay
% input_data(5, :) = [0.2, 0.9, 0.2, 65, 600, 2000]; % "vcl_fw_2_upper"
% input_data(6, :) = [0.2, 0.65, 0.1, 65, 600, 2000]; % "vcl_hw_lower" % sand
% input_data(7, :) = [0.2, 0.65, 0.3, 65, 600, 2000]; % "vcl_hw_upper"
% input_data(8, :) = [0.2, 0.65, 0.2, 50, 600, 2000]; % "fdip_lower"
% input_data(9, :) = [0.2, 0.65, 0.2, 80, 600, 2000]; % "fdip_upper"
% input_data(10, :) = [0.2, 0.65, 0.2, 65, 200, 2000]; % "zf_lower"
% input_data(11, :) = [0.2, 0.65, 0.2, 65, 1000, 2000]; % "zf_upper"
% input_data(12, :) = [0.2, 0.65, 0.2, 65, 600, 1000]; % "zmax_lower"
% input_data(13, :) = [0.2, 0.65, 0.2, 65, 600, 3000]; % "zmax_upper"

% FW: Clay, Sand; HW: Clay
% input_data(1, :) = [0.65, 0.2, 0.65, 65, 600, 2000]; % "baseline" 
% input_data(2, :) = [0.4, 0.2, 0.65, 65, 600, 2000]; % "vcl_fw_1_lower" % clay
% input_data(3, :) = [0.9, 0.2, 0.65, 65, 600, 2000]; % "vcl_fw_1_upper"
% input_data(4, :) = [0.65, 0.1, 0.65, 65, 600, 2000]; % "vcl_fw_2_lower" % sand
% input_data(5, :) = [0.65, 0.3, 0.65, 65, 600, 2000]; % "vcl_fw_2_upper"
% input_data(6, :) = [0.65, 0.2, 0.4, 65, 600, 2000]; % "vcl_hw_lower" % clay
% input_data(7, :) = [0.65, 0.2, 0.9, 65, 600, 2000]; % "vcl_hw_upper"
% input_data(8, :) = [0.65, 0.2, 0.65, 50, 600, 2000]; % "fdip_lower"
% input_data(9, :) = [0.65, 0.2, 0.65, 80, 600, 2000]; % "fdip_upper"
% input_data(10, :) = [0.65, 0.2, 0.65, 65, 200, 2000]; % "zf_lower"
% input_data(11, :) = [0.65, 0.2, 0.65, 65, 1000, 2000]; % "zf_upper"
% input_data(12, :) = [0.65, 0.2, 0.65, 65, 600, 1000]; % "zmax_lower"
% input_data(13, :) = [0.65, 0.2, 0.65, 65, 600, 3000]; % "zmax_upper"

% FW: Clay, Sand; HW: Sand
input_data(1, :) = [0.65, 0.2, 0.2, 65, 600, 2000]; % "baseline" 

input_data(2, :) = [0.4, 0.2, 0.2, 65, 600, 2000]; % "vcl_fw_1_lower" % clay
input_data(3, :) = [0.9, 0.2, 0.2, 65, 600, 2000]; % "vcl_fw_1_upper"

input_data(4, :) = [0.65, 0.1, 0.2, 65, 600, 2000]; % "vcl_fw_2_lower" % sand
input_data(5, :) = [0.65, 0.3, 0.2, 65, 600, 2000]; % "vcl_fw_2_upper"

input_data(6, :) = [0.65, 0.2, 0.1, 65, 600, 2000]; % "vcl_hw_lower" % sand
input_data(7, :) = [0.65, 0.2, 0.3, 65, 600, 2000]; % "vcl_hw_upper"

input_data(8, :) = [0.65, 0.2, 0.2, 50, 600, 2000]; % "fdip_lower"
input_data(9, :) = [0.65, 0.2, 0.2, 80, 600, 2000]; % "fdip_upper"

input_data(10, :) = [0.65, 0.2, 0.2, 65, 200, 2000]; % "zf_lower"
input_data(11, :) = [0.65, 0.2, 0.2, 65, 1000, 2000]; % "zf_upper"

input_data(12, :) = [0.65, 0.2, 0.2, 65, 600, 1000]; % "zmax_lower"
input_data(13, :) = [0.65, 0.2, 0.2, 65, 600, 3000]; % "zmax_upper"

faults_perm_mean = zeros(13, 3);
...
for r = 1 : 13
    ...
    vcl       = {[input_data(r, 1), input_data(r, 2)], input_data(r, 3)};   % fraction [-]
    dip       = [0, 0];                                                     % [deg.]
    faultDip  = input_data(r, 4);                                           % [deg.]
    zf        = [input_data(r, 5), input_data(r, 5)];                       % [FW, HW], [m]
    zmax      = {repelem(input_data(r, 6), numel(vcl{1})), repelem(input_data(r, 6), numel(vcl{2}))};  % {FW, HW}
...
save('cs_s_faults_perm_mean_output.mat', 'faults_perm_mean');
